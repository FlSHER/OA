		...
		makeDOMNodeNameBefore: function(html, setting, node) {
			...
			for (var f in fontcss) {
				fontStyle.push(f, ":", fontcss[f], ";");
                        ...
                        /* add by Fisher 2016-12-17 */
                        if(node.font !== undefined){
                            for(var f in node.font){
                                fontStyle.push(f, ":", node.font[f], ";");
                            }
                        }
                        /* end */
			html.push("<a id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level," ",node.class,"' treeNode", consts.id.A," onclick=\"", (node.click || ''), //add node.class by Fisher 2016-12-17
...
//					icoStyle.push("width:0px;height:0px;");
                                        icoStyle.push("display:none;"); // add by Fisher 2017-1-3 20:54
				}
			}
...
(function($){
	...
	_view = {
		...
		setParentNodeCheckBox: function(setting, node, value, srcNode) {
			...
			if (node.parentTId) {
				var pSign = true;
                                /* annotated by Fisher <fisher9389@sina.com> 2017-2-20 */
//				if (!value) {
