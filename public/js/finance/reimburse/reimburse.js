    ...
    "columns": [
      ...
      },
      {
        ...
        "createdCell": function (nTd, sData, oData, iRow, iCol) {
          ...
          html += ' <button class = "btn btn-sm btn-danger reject" href="#myModals" data-toggle="modal" onclick="auditReject(' + sData + ')" title = "驳回"><i class = "fa fa-times"></i></button>';
          html += '<button class = "btn btn-sm btn-success agree" title = "通过"><i class = "fa fa-check"></i></button>';
