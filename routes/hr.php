...
Route::group(['prefix' => 'hr', 'namespace' => 'HR', 'as' => 'hr'], function () {
    ...
    Route::group(['prefix' => 'leave', 'as' => '.leave'], function () {//人事请假
        ...
        Route::post('/edit', ['uses' => 'LeaveController@editByOne'])->name('.edit');
        Route::post('/export', ['uses' => 'LeaveController@export'])->name('.export');
    ...
    Route::group(['prefix' => 'attendance', 'as' => '.attendance'], function () {//考勤
        ...
        Route::post('/sync_sales_performance', ['uses' => 'AttendanceController@syncSalesPerformance'])->name('.sync_sales_performance');
    });
