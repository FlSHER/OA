                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="pending">
                                <table class="display table table-striped table-bordered reim_table" id="pending-table"></table>
                            </div>
                            ...
                            <div class="tab-pane" id="reject">
                                <table class="display table table-striped table-bordered reim_table" id="reject-table"></table>
                            </div>
                        </div>
                    </div>
                </section>
...
<!--<script type="text/javascript" src="{{source('plug_in/datatables/js/dataTables.fixedColumns.js')}}"></script>-->
<!--daterangepicker-->
...
function fnFormatDetails(table, nTr, reim_id) {
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (table == oTable) {
                sOut += '<th class="text-center">是否通过</th>';
            } else {
            ...
            if (table == oTable) {
                sOut += '<th class="text-center col-lg-1">审核金额</th>';
            }
            ...
            for (var i in msg.expenses) {
                ...
                sOut += '<tr>';
                if (table == oTable) {
                    sOut += '<td class="text-center"><div class="flat-green single-row"><div class="radio "><input type="checkbox" name="agree[]" checked value="' + expense.id + '"></div></div></td>';
                } else {
                    sOut += '<td class="text-center"><div class="flat-green single-row"><div class="radio "><input type="checkbox"';
                ...
                /* 总金额 End */
                if (table == oTable) {
                    sOut += '<td class="text-center"><div class="input-group pull-right"><span class="input-group-addon">$</span><input class="form-control text-right expense_cost" required style="width:90px;" type="text" name="" value="' + expense.approved_cost + '"></div></td>';
                }
            ...
            sOut += '</table>';
            sOut += '<script>$(".flat-green input").iCheck({checkboxClass: "icheckbox_flat-green", radioClass: "iradio_flat-green"});</script\>';
        }
    });
}
</script>
<!-- 报销相关功能 -->
<script src="{{source('js/finance/reimburse.js')}}"></script>
@endsection