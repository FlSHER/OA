                    ...
                    <section class="panel">
                        <header class="panel-heading custom-tab dark-tab">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#not-paid" data-toggle="tab">未转账</a>
                                </li>
                                <li>
                                    <a href="#paid" data-toggle="tab">已转账</a>
                                </li>
                            </ul>
                        </header>
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="not-paid">
                                    {{--搜索列表--}}
                                    @include('finance.reimburse.pay_reimburse_search')
                                    <table class="display table table-striped table-bordered reim_table"
                                           id="not-paid-table"></table>
                                </div>
...
@section('js')
    ...
    <!-- 报销相关功能 -->
    <script src="{{source('js/finance/reimburse/pay_reimburse.js')}}"></script>
    <script>
      /**
       * 详情图片调用
       *获取图片的绝对路径
      ...
      var notPaidColumns = [
        ...
        {
          title: "审核时间", data: "audit_time", name: "audit_time", sortable: true, searchable: false, visible: false,
          createdCell: function (nTd, sData, oData, iRow, iCol) {
            if (sData) $(nTd).html(sData.substring(0, 10)).attr("title", sData);
          }
        },
