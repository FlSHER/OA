...
<div class="col-lg-12">
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="adv-table">
                <table  class="display table table-bordered table-striped" id="releaseFlowTable">
...
<script type="text/javascript" src="{{asset('js/workflow/form/releaseFlow.js')}}"></script>
@stop
