...
@section('js')
    ...
    <script>
      var staffColumns = [
        ...
        {
          data: "property", title: "员工属性", type: 'select', sortable: true, visible: false, searchable: false,
          render: function (data) {
            return ['无', '108将', '36天罡', '24金刚', '18罗汉'][data];
          }
        },
        {
          ...
          createdCell: function (nTd, sData, oData, iRow, iCol) {
            ...
            if (oData.is_active == 0) {
              ...
              if (oData.status_id === 0) {
                  @if ($authority->checkAuthority(107))
      ...
      if (multibutton.length > 0) {
        buttons.push({
          "text": "<i class='fa fa-users fa-fw'></i>", "titleAttr": "批量操作", "extend": "collection",
          "buttons": multibutton
        });
      }
