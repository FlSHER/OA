            ...
            <div class="tab-content"  style="max-height:775px;overflow-x:hidden;overflow-y:auto;">
                ...
                <div class="form-horizontal tab-pane active" id="info">
                    <div class="form-group">
                        <div class="clearfix">
                            <label class="control-label col-lg-3"><strong>员工姓名：</strong></strong></label>
                            <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="col-lg-3" style="white-space: nowrap;">
                                <p class="form-control-static">{{$staff->brand->name}} - {{$staff->position->name}} <span class="badge badge-important">{{$staff->position->level}}</span></p>
                            </div>
                    ...
                    <div class="form-group" <?php if (!$staff->info->account_active) echo 'style="color:#ccc;"'; ?>>
                        <div class="clearfix">
                            ...
                            <div class="col-lg-9">
                                <p class="form-control-static">{{$staff->info->account_number}}&nbsp;&nbsp;{{$staff->info->account_name}}&nbsp;&nbsp;{{$staff->info->account_bank}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="col-lg-3">
                                <p class="form-control-static">@if($staff->info->height) {{$staff->info->height}}cm @endif/@if($staff->info->weight) {{$staff->info->weight}}kg @endif</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="clearfix">
                            ...
                            <div class="col-lg-3">
                                <p class="form-control-static">{{$staff->info->relative_name}}@if($staff->info->relative_type) （{{$staff->info->relative_type}}） @endif</p>
                            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">@if($log->admin_sn == 999999)开发者@else{{$log->admin->realname}}@endif</td>
                            ...
                            <tr class="log_detail" style="display:none;">
                                <td colspan="4" class="row bg-primary">
                                    ...
                                    <div class="row m-bot15">
                                        ...
                                        <div class="col-xs-4" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;" title="{{$change[0]}}">{{$change[0]}}</div>
                                        <div class="col-xs-1"><i class="fa fa-arrow-right"></i></div>
                                        <div class="col-xs-4" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;" title="{{$change[1]}}">{{$change[1]}}</div>
                                    </div>
                                    @else
                                    <div class="row m-bot15">
                                    ...
                                    <div class="row m-bot15">
                                        <div class="col-xs-2 col-xs-offset-1"><strong>{{$attribute}} :</strong></div>
                                        <div class="col-xs-4" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;" title="{{$value[0]}}">{{$value[0]}}</div>
                                        <div class="col-xs-1"><i class="fa fa-arrow-right"></i></div>
                                        <div class="col-xs-4" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;" title="{{$value[1]}}">{{$value[1]}}</div>
                                    </div>
                                    @endforeach
                                    @endif
                                    @endforeach
