<div id="{{$type}}ByOne" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="{{$type}}Form" class="form-horizontal" method="post" action="{{source(route('hr.staff.submit'))}}">
                ...
                <div class="tab-content modal-body" style="padding-bottom:0px;">
                    ...
                    <div class="tab-pane fade in active basicInfo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input class="form-control id_card_number" name="info[id_card_number]" type="text" title="身份证号">
                            </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2">*员工姓名</label>
                            <div class="col-sm-3">
                                <input class="form-control" name="realname" type="text" title="员工姓名" placeholder="请输入2-10个字符" disabled>
                            </div>
                            @if(in_array($type, ['transfer']))
                            <div class="col-sm-2 text-right">
                                <button type="button" class="btn btn-danger" title="调离" onclick="transferOut()"><i class="fa fa-sign-out"></i></button>
                            </div>
                            @endif
                        </div>
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group" oaSearch="shop">
                                    <input class="form-control" name="shop_sn" oaSearchColumn="shop_sn" type="text" title="店铺编号"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="status_id" title="员工状态" <?php if (!in_array($type, ['edit'])) { ?>locked="true"<?php } ?>>
                                    @if($type == 'leave')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="info[remark]" title="员工备注" style="resize: none" rows="5" placeholder="最大长度200字符"></textarea>
                            </div>
                        </div>
                        @endif
                        <div class="form-group <?php if ($type == 'edit') { ?>hidden<?php } ?>">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" name="operate_at" type="text" isDate title="执行时间" <?php if ($type == 'edit') { ?>value="{{date('Y-m-d')}}"<?php } ?> locked="true"/>
                            </div>
                            <div class="col-sm-1"></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="operation_remark" title="操作说明" style="resize: none" rows="5" placeholder="最大长度100字符"></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- 基本信息 end -->
                    ...
                    <div class="tab-pane fade personalInfo1">  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="info[account_bank]" type="text" title="开户行" placeholder="如：中国农业银行成都荷花池支行"/>
                            </div>
                            <div class="col-sm-4  form-control-static">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="info[living_address]" type="text" title="现居住地" placeholder="详细地址，请输入0-30个字符">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" oaSearch="all_staff">
                                <div class="input-group">
                                    <input class="form-control" name="info[recruiter_name]" oaSearchColumn="realname" type="text" title="招聘人员" style="background-color:#fff;" readonly/>
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default" oaSearchShow><i class="fa fa-search"></i></button>
                                    </span>
                                </div>
                                <input class="form-control" name="info[recruiter_sn]" oaSearchColumn="staff_sn" type="hidden"/>
                            </div>
                        </div>
                    </div>
                    <!-- 个人信息1 end -->
                    ...
                    <div class="tab-pane fade personalInfo2">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control pick_date" name="birthday" isDate type="text" title="生日"/>
                            </div>
                            <div class="col-sm-1"></div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2"></label>
                            <div class="col-sm-10">
                                <input class="form-control" name="info[household_address]" type="text" title="户口所在地" placeholder="详细地址，请输入0-30个字符">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">籍贯</label>
                            <div class="col-sm-10">
                                <input class="form-control" name="info[native_place]" type="text" title="籍贯" placeholder="请输入0-30个字符"/>
                            </div>
                        </div>
                        @if($authority->checkAuthority(59))
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" name="info[mini_shop_sn]" type="text" title="微商城编码" />
                            </div>
                            <div class="col-sm-1"></div>
                    ...
                    <div class="tab-pane fade relativeInfo">  
                        <div class="form-group" isFormList>
                            ...
                            <div class="col-sm-4">
                                <div class=" input-group">
                                    <input class="form-control" name="relative[][pivot][relative_name]" oaSearchColumn="realname" type="text" title="关系人" style="background-color:#fff;" readonly/>
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default" oaSearchShow><i class="fa fa-search"></i></button>
                                    </span>
                                </div>
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="relative[][pivot][relative_type]" title="关系类型">
                                    ...
                                    {!! get_options('staff_relative_type','name','id') !!}
                                </select>
                            </div>
                        </div>
                    </div>
