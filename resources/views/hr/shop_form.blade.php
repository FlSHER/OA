<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input class="form-control" name="clock_out" type="text" value="21:00" isTime title="下班时间"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4" oaSearch="staff">
            <div class="input-group">
                <input class="form-control" name="manager_name" oaSearchColumn="realname" type="text" title="店长"
                ...
                <div class="col-sm-6" isFormList>
                    <div class="row">
                        <div class="input-group col-xs-10">
                            <input class="form-control" name="staff[][realname]" oaSearchColumn="realname" type="text"
                                   title="关系人" style="background-color:#fff;" readonly/>
                            <span class="input-group-btn">
