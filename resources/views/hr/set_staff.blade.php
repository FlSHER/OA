<div id="setStaff" class="modal fade">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form id="setStaffForm" class="form-horizontal" method="post" action="{{$submitUrl or asset(route('hr.staff.multi_set'))}}">
                <div class="modal-body">
                    <button type="button" class="btn btn-default m-bot15" onclick="searchStaff()"><i class="fa fa-user-plus"></i></button>
                    <style>
                        .alert.alert-tag{
