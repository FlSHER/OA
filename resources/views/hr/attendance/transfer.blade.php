...
var columns = [
    ...
    {data: "leaving_shop.name", title: "调离店铺名称", defaultContent: "无"},
    {data: "{leaving_shop.province.name}.'-'.{leaving_shop.city.name}.'-'.{leaving_shop.county.name}.' '.{leaving_shop.address}", name: "leaving_shop.address", title: "调离店铺地址", visible: false},
