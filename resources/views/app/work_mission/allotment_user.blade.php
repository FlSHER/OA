...
<div class="col-lg-7">
    <section class="panel">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="userTitle">添加人员配置</h4>
                    </div>
                    <div class="modal-body">
                        <form action="/app/work_mission/allotment_user/save" method="post" id="userForm" class="form-horizontal" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group" isFormList>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="department[][department_id]" title="部门">
        ...
        <div class="panel-body">
            <div class="adv-table">
                <table  class="display table table-bordered table-striped" id="allotmentUserTable">
...
<!--审批人-->
<script type="text/javascript" src="{{source('js/app/work_mission/allotment_user.js')}}"></script>
@stop