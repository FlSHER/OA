...
namespace Fisher\Amap\Handlers;

use App\Utils\Path;
use Illuminate\Console\Command;
use Illuminate\Contracts\Foundation\Application as ApplicationContract;

class DevPackageHandler extends \App\Support\PackageHandler
{
    /**
    ...
    public function makeMigrationHandle(Command $command)
    {
        ...
        $path = Path::relative(
            $this->app->basePath(),
            $this->app->make('path.amap.migrations')
        );
    ...
    {
        $path = $this->app->make('path.amap.seeds');
        ...
        $content = file_get_contents(
            $this->app->make('path.amap.resources').'/stubs/seeder'
        );
    ...
    public function makeModelHandle(Command $command)
    {
        ...
        $content = file_get_contents(
            $this->app->make('path.amap.resources').'/stubs/model'
        );
        $variable = [
            '{--name--}' => $modelName,
            '{--table-name--}' => $table,
